...
public class ReceiveHolder extends BaseViewHolder<MessageEntity> {
    //文本消息
    ...
    public ReceiveHolder(View view, int viewType, ChatListenter listenter) {
        super(view);
    ...
    public void setData(final MessageEntity data) {
        ...
        switch (data.getType()) {
            case LEFT_CHAT_FILE_TYPE_TEXT://文本消息
