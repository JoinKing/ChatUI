...
public class ZoomImageView extends android.support.v7.widget.AppCompatImageView implements OnScaleGestureListener,
    ...
    public ZoomImageView(Context context, AttributeSet attrs) {
        ...
        mGestureDetector = new GestureDetector(context,
                new SimpleOnGestureListener() {
                    ...
                    public boolean onSingleTapConfirmed(MotionEvent e) {
                        RxBus.getDefault().post(new ZoomBus());
        ...
        mScaleGestureDetector = new ScaleGestureDetector(context, this);   //缩放手势检测
        this.setOnTouchListener(this);  //这个借口主要有onScale()、onScaleBegin()、onScaleEnd()方法
    }
    ...
    private void checkBorderAndCenterWhenScale() {
        ...
        mScaleMatrix.postTranslate(deltaX, deltaY);  //deltaX大于0表示向右,deltaY大于0表示向下
...
//		Log.d("mscale_x", matrixValues[Matrix.MSCALE_X]+ "");
//		Log.d("mscale_y",matrixValues[Matrix.MSCALE_Y]+"");
        return matrixValues[Matrix.MSCALE_X];  //matrixValues[Matrix.MSCALE_X]与matrixValues[Matrix.MSCALE_Y]是一样的
    }
    ...
    //根据图片的宽和高以及屏幕的宽和高，对图片进行缩放以及移动至屏幕的中心。如果图片很小，那就正常显示，不放大了~
    @Override
